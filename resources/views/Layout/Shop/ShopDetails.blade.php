            ...
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    ...
                    <div class="breadcrumb__option">
                        ...
                        <a href="{{ url('shopdetails/'.$product->id) }}">{{ $product->department($product->product_department_id)->department_name }}</a>
        ...
        <div class="row">
                ...
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large"
                            src="/{{ $product->product_thumbnail }}" alt="">
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <ul>
                        <li><b>In Stock</b> <span>{{ $product->product_quantity }}</span></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6><a href="#">{{ $product_->product_name }}</a></h6>
